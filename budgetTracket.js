export default class budgetTracker{
    ...
    static entryHtml()
    {
        return `
            <tr>
                ...
                <td>
                    <input type="number" class="input input-amount" placeholder="Enter the amount">
                </td>
    ...
    load()
    {
        const entries = JSON.parse(localStorage.getItem("budget-tracket-entries-dev") || "[]");
    ...
    save()
    {
        const data = this.getEntryRows().map(row => {
         ...
         localStorage.setItem("budget-tracket-entries-dev",JSON.stringify(data));
         this.updateSummary();
    }
